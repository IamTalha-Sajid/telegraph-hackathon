...
// Example copy comes from the Season II brief. `intents` map each example to the intent
// catalogue; `needs` lists intelligence the example requires that has no catalogue intent yet.
      ...
      examples: [
        {
          ...
          intents: ['SMART_CONTRACT_AUDIT', 'ONCHAIN_METRIC_VERIFY', 'SANCTIONS_SCREENING_MATCH', 'SOCIAL_BOT_DETECTION'],
          needs: ['Commit history and contributor authenticity'],
        },
        {
          ...
          needs: ['Order-book anomaly detection'],
        },
        {
        ...
        examples: [
          {
            ...
            intents: ['CRYPTO_TRANSFER_VERIFY', 'TASK_EXECUTION_QUALITY', 'GAS_PRICE_ESTIMATION'],
          },
          {
            ...
            intents: ['SANCTIONS_SCREENING_MATCH', 'TRANSACTION_RISK'],
            needs: ['Wallet address risk score', 'Jurisdiction eligibility'],
          },
          {
        ...
        examples: [
          {
            ...
            intents: ['VESSEL_TELEMETRY_VERIFY', 'DOCUMENT_AUTHENTICITY', 'EXPORT_CONTROL_CLASSIFICATION'],
            needs: ['Bill-of-lading verification', 'Customs clearance status'],
          },
          {
            ...
            intents: ['QUESTION_ANSWERING', 'FX_NOW', 'WEATHER_CURRENT'],
          },
          {
            ...
            intents: ['ASSET_RESERVE_ATTESTATION', 'CRYPTO_PRICE_LOOKUP', 'FX_NOW'],
            needs: ['Gold spot price'],
          },
        ],
      },
      {
        ...
        examples: [
          {
            ...
            intents: ['COLLATERAL_HAIRCUT_VALUATION', 'CRYPTO_YIELD_RATE', 'ONCHAIN_METRIC_VERIFY'],
          },
          {
            ...
            intents: ['COLLATERAL_HAIRCUT_VALUATION', 'ASSET_RESERVE_ATTESTATION', 'CORPORATE_REGISTRY_LOOKUP'],
          },
          {
      ...
      examples: [
        {
          ...
          intents: ['COLLATERAL_HAIRCUT_VALUATION', 'LOAN_INTEREST_RATE_QUOTE', 'MACRO_ECONOMIC_INDICATOR', 'FX_NOW'],
        },
        {
          ...
          intents: ['CORPORATE_REGISTRY_LOOKUP', 'SANCTIONS_SCREENING_MATCH', 'LOAN_INTEREST_RATE_QUOTE', 'MACRO_ECONOMIC_INDICATOR'],
          needs: ['Jurisdiction eligibility', 'Comparable issuance terms'],
        },
        {
          ...
          intents: ['CORPORATE_REGISTRY_LOOKUP', 'SANCTIONS_SCREENING_MATCH', 'COLLATERAL_HAIRCUT_VALUATION'],
        },
      ],
    }],
  },
      ...
      examples: [
        {
          ...
          intents: ['REGULATORY_FILING_MONITOR', 'URL_CONTENT_EXTRACTION', 'TEXT_SUMMARIZATION', 'LANGUAGE_TRANSLATION'],
        },
        {
          ...
          intents: ['CORPORATE_REGISTRY_LOOKUP', 'SANCTIONS_SCREENING_MATCH', 'WEB_SEARCH_QUERY', 'FACT_CHECKING'],
          needs: ['Litigation history', 'Adverse media screening'],
        },
        {
          ...
          intents: ['CONTRACT_OBLIGATION_AUDIT', 'QUESTION_ANSWERING'],
          needs: ['Clause benchmarking', 'Enforceability by jurisdiction'],
        },
      ],
    }],
  },
        ...
        examples: [
          {
            ...
            intents: ['MEDIA_FORENSIC_VERIFY', 'FACT_CHECKING', 'WEB_SEARCH_QUERY', 'SATELLITE_IMAGERY_ANALYSIS'],
            needs: ['Military movement corroboration'],
          },
          {
            ...
            needs: ['Night lights', 'Rail loadings'],
          },
          {
            ...
            intents: ['FACT_CHECKING', 'WEB_SEARCH_QUERY', 'TEXT_SUMMARIZATION'],
          },
        ],
      },
      {
        ...
        examples: [
          {
            ...
            intents: ['VESSEL_TELEMETRY_VERIFY', 'LIVE_PORT_CONGESTION', 'SATELLITE_IMAGERY_ANALYSIS'],
            needs: ['Dark-fleet detection', 'War-risk insurance rates'],
          },
          {
            ...
            intents: ['MEDIA_FORENSIC_VERIFY', 'SOCIAL_BOT_DETECTION', 'IMAGE_CAPTIONING'],
            needs: ['Frame geolocation', 'Upload history'],
          },
          {
            ...
            intents: ['FACT_CHECKING', 'VESSEL_TELEMETRY_VERIFY', 'MEDIA_FORENSIC_VERIFY'],
          },
        ],
      },
      {
        ...
        examples: [
          {
            ...
            intents: ['FACT_CHECKING', 'FX_NOW', 'LOAN_INTEREST_RATE_QUOTE', 'GRID_POWER_PRICE'],
          },
          {
            ...
            intents: ['FACT_CHECKING', 'SENTIMENT_ANALYSIS', 'TEXT_SUMMARIZATION'],
          },
          {
            ...
            intents: ['FACT_CHECKING', 'EVENT_OUTCOME_RESOLUTION', 'CROSS_CHAIN_STATE_VERIFY'],
          },
        ],
      },
    ],
        ...
        examples: [
          {
            ...
            intents: ['WEATHER_FORECAST_VERIFY', 'SATELLITE_IMAGERY_ANALYSIS', 'LIVE_PORT_CONGESTION', 'ROUTE_ETA'],
            needs: ['Cyclone tracking', 'Road and rail closures'],
          },
          {
            ...
            intents: ['WEATHER_FORECAST_VERIFY', 'SHIPMENT_DELAY_RISK', 'ROUTE_ETA'],
            needs: ['Gold spot price'],
          },
          {
            ...
            intents: ['SENSOR_TELEMETRY_VERIFY', 'AIR_QUALITY_INDEX', 'WEATHER_CURRENT'],
          },
        ],
      },
      {
        ...
        examples: [
          {
            ...
            intents: ['SATELLITE_IMAGERY_ANALYSIS', 'SENSOR_TELEMETRY_VERIFY', 'WEATHER_FORECAST_VERIFY', 'SHIP_RATE_ETA'],
            needs: ['Feed prices'],
          },
          {
            ...
            intents: ['SENSOR_TELEMETRY_VERIFY', 'DOCUMENT_AUTHENTICITY', 'COLD_CHAIN_TEMPERATURE_BREACH'],
          },
          {
        ...
        examples: [
          {
            ...
            intents: ['SATELLITE_IMAGERY_ANALYSIS', 'WEATHER_FORECAST_VERIFY', 'MACRO_ECONOMIC_INDICATOR'],
            needs: ['Soil moisture', 'Pest and disease pressure'],
          },
          {
            ...
            intents: ['WEATHER_FORECAST_VERIFY', 'SHIP_RATE_ETA'],
            needs: ['Fertiliser and fuel prices'],
          },
          {
        ...
        examples: [
          {
            ...
            intents: ['QUESTION_ANSWERING', 'WEB_SEARCH_QUERY', 'FACT_CHECKING'],
          },
          {
            ...
            intents: ['FACT_CHECKING', 'MEDIA_FORENSIC_VERIFY', 'SOCIAL_BOT_DETECTION'],
          },
          {
        ...
        examples: [
          {
            ...
            intents: ['MEDIA_FORENSIC_VERIFY', 'PRODUCT_AUTHENTICITY', 'FACT_CHECKING', 'IMAGE_CAPTIONING'],
            needs: ['Graded collectible comparables'],
          },
          {
            ...
            needs: ['Queue length and crowd density'],
          },
          {
      ...
      },
      {
        ...
        examples: [
          ...
          },
          {
            ...
            intents: ['SOCIAL_BOT_DETECTION', 'TOXICITY_MODERATION', 'TEXT_CLASSIFICATION'],
          },
        ],
      },
    ],
      ...
      examples: [
        {
          ...
          intents: ['LIVE_PORT_CONGESTION', 'VESSEL_TELEMETRY_VERIFY', 'WEATHER_FORECAST_VERIFY'],
          needs: ['Freight rates', 'Outage reports'],
        },
        {
        ...
        },
        {
          ...
          needs: ['Capacity-limited premium answers'],
        },
      ],
    }],
  },
        ...
        examples: [
          {
            ...
            intents: ['WEB_SEARCH_QUERY', 'QUESTION_ANSWERING', 'WEATHER_CURRENT', 'CRYPTO_PRICE_LOOKUP'],
          },
          {
            ...
            intents: ['URL_CONTENT_EXTRACTION', 'TASK_EXECUTION_QUALITY'],
          },
          {
      ...
      },
      {
        ...
        examples: [
          ...
          },
          {
            ...
            intents: ['TASK_EXECUTION_QUALITY', 'AGENT_TOOL_CALL_AUDIT'],
          },
          {
            ...
            intents: ['SYNTHETIC_DATA_FIDELITY', 'TASK_EXECUTION_QUALITY'],
            needs: ['Labelled agent trajectories'],
          },
        ],
      },
      {
        ...
        examples: [
          {
            ...
            intents: ['URL_CONTENT_EXTRACTION', 'WEB_SEARCH_QUERY', 'LIVE_SHELF_PRICE'],
          },
          {
            ...
            intents: ['VENDOR_VERIFY', 'EXPORT_CONTROL_CLASSIFICATION', 'SHIP_RATE_ETA', 'FX_NOW'],
          },
          {
        ...
        examples: [
          {
            ...
            intents: ['SECURITY_REVIEW', 'VULNERABILITY_TRIAGE', 'CODE_REVIEW'],
            needs: ['Dependency provenance', 'Maintainer authenticity'],
          },
          {
            ...
            intents: ['QUESTION_ANSWERING', 'CODE_GENERATION', 'RAG_GROUNDING_VERIFY'],
          },
          {
        ...
        examples: [
          {
            ...
            intents: ['LLM_OUTPUT_EVALUATION', 'QUESTION_ANSWERING', 'FACT_CHECKING'],
          },
          {
        ...
        examples: [
          {
            ...
            intents: ['WILDFIRE_PERIMETER_MONITOR', 'SATELLITE_IMAGERY_ANALYSIS', 'WEATHER_FORECAST_VERIFY', 'ROUTE_ETA'],
          },
          {
          ...
          },
          {
            ...
            needs: ['Specialist perception and diagnostics'],
          },
        ],
      },
      {
        ...
        examples: [
          {
            ...
            needs: ['Visual anomaly classification'],
          },
          {
            ...
            intents: ['WAREHOUSE_INVENTORY', 'DOCUMENT_AUTHENTICITY', 'SENSOR_TELEMETRY_VERIFY'],
            needs: ['Carton damage assessment'],
          },
          {
            ...
            intents: ['IMAGE_CAPTIONING', 'TEXT_CLASSIFICATION'],
            needs: ['Rare failure classification'],
          },
        ],
      },
      {
        ...
        examples: [
          {
            ...
            intents: ['QUESTION_ANSWERING', 'IMAGE_CAPTIONING'],
            needs: ['Task decomposition and manipulation policies'],
          },
          {
        ...
        examples: [
          {
            ...
            intents: ['MINING_HASHPRICE_VERIFY', 'GRID_POWER_PRICE'],
            needs: ['Difficulty projection', 'AI compute lease comparables'],
          },
          {
            ...
            intents: ['ASSET_RESERVE_ATTESTATION', 'CORPORATE_REGISTRY_LOOKUP', 'COLLATERAL_HAIRCUT_VALUATION'],
          },
          {
            ...
            needs: ['Firmware tuning curves and failure signatures'],
          },
        ],
      },
      {
        ...
        examples: [
          ...
          },
          {
            ...
            intents: ['WEB_SEARCH_QUERY', 'REGULATORY_FILING_MONITOR', 'SENTIMENT_ANALYSIS'],
            needs: ['Interconnect queue position', 'Water availability'],
          },
        ],
      },
      {
        ...
        examples: [
          {
            ...
            needs: ['Demand-response event probability'],
          },
          {
            ...
            intents: ['WEATHER_CURRENT', 'GRID_POWER_PRICE', 'DATACENTER_TELEMETRY_VERIFY'],
            needs: ['Hardware failure prediction'],
          },
          {
        ...
        examples: [
          {
            ...
            intents: ['WEB_SEARCH_QUERY', 'FACT_CHECKING', 'REGULATORY_FILING_MONITOR', 'MACRO_ECONOMIC_INDICATOR'],
          },
          {
            ...
            intents: ['WEB_SEARCH_QUERY', 'CORPORATE_REGISTRY_LOOKUP', 'FACT_CHECKING'],
            needs: ['Secondary transaction comparables', 'Hiring velocity'],
          },
          {
            ...
            intents: ['EVENT_OUTCOME_RESOLUTION', 'FACT_CHECKING', 'WEB_SEARCH_QUERY'],
          },
        ],
      },
      {
        ...
        examples: [
          {
            ...
            intents: ['WEB_SEARCH_QUERY', 'REGULATORY_FILING_MONITOR', 'ENTITY_EXTRACTION'],
            needs: ['Patent filings', 'Shipment records'],
          },
          {
          ...
          },
          {
            ...
            intents: ['ASSET_RESERVE_ATTESTATION', 'CRYPTO_PRICE_LOOKUP', 'ONCHAIN_METRIC_VERIFY'],
          },
        ],
      },
      {
        ...
        examples: [
          ...
          },
          {
            ...
            intents: ['WASH_TRADING_DETECTION', 'LIQUIDITY_DEPTH_VERIFY', 'CRYPTO_PRICE_LOOKUP'],
          },
          {
            ...
            intents: ['CRYPTO_PRICE_LOOKUP', 'TOKEN_TOTAL_SUPPLY_VERIFY'],
          },
        ],
      },
      {
    ...
    buyers: [{
      ...
      examples: [
        ...
        },
        {
          ...
          intents: ['SMART_CONTRACT_AUDIT', 'VULNERABILITY_TRIAGE', 'SECURITY_REVIEW'],
          needs: ['Exploit proof verification'],
        },
      ],
    }],
  },
...
export function trackNeeds(t: Track) {
  return Array.from(new Set(trackExamples(t).flatMap(ex => ex.needs ?? [])))
}
